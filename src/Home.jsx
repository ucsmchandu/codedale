      ...
      <div className="mt-20 w-full">
        <Swiper
          ...
          breakpoints={{
            ...
            640: { slidesPerView: 1.3, spaceBetween: 14 }, // small tabs
            1024: { slidesPerView: 1.7, spaceBetween: 16 }, // laptops
            1280: { slidesPerView: 2, spaceBetween: 18 }, // desktops
            1536: { slidesPerView: 2, spaceBetween: 18 }, // big monitor (still 2 only)
          }}
          centeredSlides={false} // makes spacing consistent
        >
          {cardsData.map((card) => (
            <SwiperSlide key={card.id}>
              <div className="flex justify-center">
                {" "}
                {/* helps avoid excess gaps */}
                <Cards data={card} />
              </div>
            </SwiperSlide>
          ))}
